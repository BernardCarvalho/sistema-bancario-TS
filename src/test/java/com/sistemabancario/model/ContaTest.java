...
public class ContaTest {
    ...
    void testGetSaldoTotal(){
        ...
        final double saldoTotalEsperado = limite;
        instance.setEspecial(true);
        instance.setLimite(limite);
        final double SaldoTotalObtido = instance.getSaldoTotal();
        assertEquals(saldoTotalEsperado, SaldoTotalObtido);
    }
    
    @Test
    void testDepositoDinheiro(){
        final double limite = 400.6, deposito = 400.8, esperado = 801.4;
        final Conta instance = new Conta();
        instance.setEspecial(true);
        instance.setLimite(limite);
