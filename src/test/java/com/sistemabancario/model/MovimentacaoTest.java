...
class MovimentacaoTest {
    ...
    /**
     * R01 - verifica se ocorre erro ao tentar inserir um tipo de operacao não suportada
     */
    @Test
    void testR01SetTipoNaoSuportado(){
        final Movimentacao instance = new Movimentacao(new Conta());
        final char tipoNaoSuportado = 'H';
        
        assertThrows(IllegalStateException.class, () -> instance.setTipo(tipoNaoSuportado));
    }
    
    /**
     * R02 - O valor da operacao não pode ser negativo
     */
    @Test
    void testR02SetValorNegativo(){
        final Movimentacao instance = new Movimentacao(new Conta());
        final int valorNaoSuportado = -2500;
        assertThrows(IllegalArgumentException.class,()-> instance.setValor(valorNaoSuportado));
    }
    /**
     * R03 - Verifica uma operacao de debito com valor superior ao saldo da conta
     */
